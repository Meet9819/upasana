...
echo ' 
                ...
                <div class="col-sm-6 col-md-4 event-listing">
                    <div class="images_row row m0">
                        <a href="achievementsdetail.php?q='.$row['id'].'"><img src="media/achievements/'.$row['img'].'" alt=""></a>
                    </div>
                    <div class="event_excepts row m0">
                        ...
                        <a href="achievementsdetail.php?q='.$row['id'].'" class="btn-primary btn-outline">read more</a>
                    </div>
