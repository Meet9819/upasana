	...
	<div class="main-content">
			...
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">View Skills</h4>
...
if(isset($_GET['del']))
{
    $SQL = mysqli_query($con,"DELETE FROM requirement WHERE id=".$_GET['del']);
 ?>
                <script>
...
echo '	<tbody>
			<tr>
			 ';?>
                                                    ...
                                                    <?php echo '
								<td><img style="width:100px" src="../media/requirement/'.$row['img'].'"></td>
								
							
								  <td> '.$row['name'].'</td>

								 <td> '.substr($row['detail'],0,200).'...</td>
...
<a  href="requirementedit.php?edit_id='.$row['id'].'" style="font-size: 12px;
    line-height: 22px;
