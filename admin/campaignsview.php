	...
	<div class="main-content">
			...
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">View Campaigns</h4>
...
if(isset($_GET['del']))
{
    $SQL = mysqli_query($con,"DELETE FROM campaigns WHERE id=".$_GET['del']);
 ?>
                <script>
...
echo '	<tbody>
			<tr>
			 ';?>
                                                    ...
                                                    <?php echo '
								<td><img style="width:200px" src="../media/campaigns/'.$row['img'].'"></td>
...
<a  href="campaignsedit.php?edit_id='.$row['id'].'" style="font-size: 12px;
    line-height: 22px;
