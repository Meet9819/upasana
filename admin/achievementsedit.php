	...
	<div class="main-content">
		...
		<div class="col-lg-12 col-xs-12">
				<div class="box-content card white">
					<h4 class="box-title">Edit Achievements</h4>
					<!-- /.box-title -->
...
<?php
    ...
    {
        $id = $_GET['edit_id'];
        $stmt_edit = $DB_con->prepare('SELECT img,title,description,campid,video,fb FROM achievements WHERE id =:id');
    ...
    if(isset($_POST['btn_save_updates']))
    {
        ...
        if($imgFile)
        {
            $upload_dir = '../media/achievements/'; // upload directory 
...
$stmt = $DB_con->prepare('UPDATE achievements SET img=:img,description=:description,title=:title,video=:video,campid=:campid,fb=:fb
    WHERE id=:id');
            ...
            if($stmt->execute()){
                ...
                window.location.href='achievementsview.php';
                </script>
                <?php
            }
            else{
...
?>
  ...
  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
 		...
 		<div class="form-group">
								...
								<div class="col-sm-6"> 
									  ...
									  <img src="../media/achievements/<?php echo $img; ?>" height="70" width="150" />
  ...
  <input type="file" name="user_image" accept="image/*" />
                            ...
                            <div class="form-group">
                                <label for="inp-type-1" class="col-sm-3 control-label">Title of Achievements</label>
                                <div class="col-sm-6">
...
?>
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea type="text" name="fb" class="form-control" id="" placeholder="Enter FB URL" required="" > 
