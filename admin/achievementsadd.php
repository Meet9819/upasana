	...
	<div class="main-content">
		...
		<div class="col-lg-12 col-xs-12">
				<div class="box-content card white">
					<h4 class="box-title">Add Achievements</h4>
					<!-- /.box-title -->
...
if (!isset($_FILES['image']['tmp_name'])) {
    ...
    $image_name= addslashes($_FILES['image']['name']);
            ...
            move_uploaded_file($_FILES["image"]["tmp_name"],"../media/achievements/" . $_FILES["image"]["name"]);
            ...
            $save=mysqli_query($con,"INSERT INTO achievements (img,title,description,campid,video,fb) VALUES 
