...
if(isset($_GET['del']))
{
    $SQL = mysqli_query($con,"DELETE FROM event WHERE id=".$_GET['del']);
 ?>
                <script>
...
echo '	<tbody>
			<tr>
			 ';?>
                                                    ...
                                                    <?php echo '
								<td><img style="width:200px" src="../media/event/'.$row['img'].'"></td>
...
<a  href="eventedit.php?edit_id='.$row['id'].'" style="font-size: 12px;
    line-height: 22px;
